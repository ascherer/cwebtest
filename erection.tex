...
\N[2 erection.w]{1}{1}Intro. This is a transcription of my ``random matroid''
program in \#P72.
...
\M[48 erection.w]{2}\B\X2:Set initial contents of \PB{\\{rank}} table\X${}\E{}$%
\6
$\|k\K\T{1};{}$\6
${}\\{rank}[\T{0}]\K\T{100};{}$\6
\&{while} ${}(\|k\Z\\{mask}){}$\5
...
\M[55 erection.w]{3}The published paper had a comparatively inefficient
algorithm here;
...
\M[62 erection.w]{4}\B\X4:Pass from rank $r$ to $r+1$\X${}\E{}$\6
${}\{{}$\1\6
...
\M[74 erection.w]{5}\B\X5:Create empty list\X${}\E{}$\6
$\\{nh}\K\\{avail};{}$\6
\&{if} (\\{nh})\1\5
${}\\{avail}\K\|L[\\{nh}];{}$\2\6
\&{else}\1\5
...
\M[80 erection.w]{6}\B\X6:Return list \PB{\|h} to available storage\X${}\E{}$\6
...
\M[84 erection.w]{7}\B\X7:Assign rank to sets and print independent ones\X${}%
\E{}$\6
...
\M[89 erection.w]{8}The \PB{\\{generate}} procedure inserts minimal closed sets
for rank \PB{$\|r+\T{1}$}
...
\M[106 erection.w]{9}\B\X9:Find all sets in list \PB{\\{nh}} that already
contain \PB{\|y} and remove excess elements from \PB{\|t}\X${}\E{}$\6
\&{for} ${}(\|k\K\|L[\\{nh}];{}$ ${}\|k\I\\{nh};{}$ ${}\|k\K\|L[\|k]){}$\1\6
\&{if} ${}((\|S[\|k]\AND\|y)\E\|y){}$\1\5
${}\|t\MRL{\AND{\K}}\CM\|S[\|k]{}$;\2\2\par
\U8.\fi

\M[110 erection.w]{10}\B\X10:Insert $y\cup a$ for each $a\in t$\X${}\E{}$\6
\&{while} (\|t)\5
${}\{{}$\1\6
${}\|x\K\|y\OR(\|t\AND{-}\|t);{}$\6
...
\M[117 erection.w]{11}The following key procedure basically inserts the set %
\PB{\|x} into list \PB{\\{nh}}.
...
\M[145 erection.w]{12}The \PB{\\{enlarge}} procedure inserts sets that are read
from standard input
...
\M[159 erection.w]{13}We don't output a set as a hexadecimal number according
to the
...
\M[171 erection.w]{14}\B\X8:Subroutines\X${}\mathrel+\E{}$\6
...
\M[179 erection.w]{15}The subroutine \PB{\\{mark}(\|m)} sets $\PB{%
...
\M[196 erection.w]{16}I've added a \PB{\\{tl}} array to the data structure, to
...
\M[218 erection.w]{17}The parameter \PB{\\{card}} is 100 plus the cardinality
of \PB{\|m}
...
\M[233 erection.w]{18}\B\X8:Subroutines\X${}\mathrel+\E{}$\6
