...
\N[2 domination.w]{1}{1}Intro. A quick program to output the ``domination'' or
``majorization''
...
\M[56 domination.w]{2}\B\X2:Set \PB{\\{work}} to the string that is to be
...
\M[78 domination.w]{3}Here I use ye olde Algorithm 7.2.1.2L.
...
\M[96 domination.w]{4}We use the fact that dominance is a subset of (reverse)
lexicographic order.
...
\M[113 domination.w]{5}Hey, I'm just using brute force today.
...
\M[124 domination.w]{6}\B\X6:Print the results\X${}\E{}$\6
