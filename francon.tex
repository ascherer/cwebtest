...
\N[5 francon.w]{1}{1}Introduction. This short program implements a Fran%
\c{c}on-inspired
...
\M[42 francon.w]{2}Nested strings (aka Dyck words) are conveniently generated
by
...
\M[49 francon.w]{3}At this point, variable \PB{\|i} is the position of the
rightmost `$+1$' in \PB{\|d}.
...
\M[62 francon.w]{4}\B\X4:Check the Strahler number\X${}\E{}$\6
...
\M[71 francon.w]{5}\B\X5:Subroutines\X${}\E{}$\6
...
\N[80 francon.w]{1}{6}The main algorithm.
...
\M[118 francon.w]{7}Variable \PB{\|m} represents the number of nodes in the
tree; variable \PB{\|p}
...
\M[140 francon.w]{8}Let the binary representation of \PB{\\{kk}} be $(b_t\ldots
b_0)_2$.
...
\N[154 francon.w]{1}{9}The inverse algorithm. To reverse the process, we simply
look at the
