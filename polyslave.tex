...
\N[3 polyslave.w]{1}{1}Introduction. This program obediently carries out the
wishes of
...
\M[35 polyslave.w]{2}It is easy to adapt this program to work with counters
that occupy either
...
\M[62 polyslave.w]{3}The program checks frequently that everything in the input
file
...
\M[75 polyslave.w]{4}Several gigabytes of input might be needed, so the input
file name will
...
\M[94 polyslave.w]{5}\B\X5:Global variables\X${}\E{}$\6
...
\M[99 polyslave.w]{6}\B\X6:Local variables\X${}\E{}$\6
...
\N[103 polyslave.w]{1}{7}Input. Let's start with the basic routines that are
needed to
...
\M[125 polyslave.w]{8}\B\X3:Subroutines\X${}\mathrel+\E{}$\6
...
\M[137 polyslave.w]{9}If the check sum is bad, we go back to the beginning.
Some incorrect
...
\M[156 polyslave.w]{10}My first draft of this program simply used \PB{%
\\{fread}} to input one or three
...
\M[185 polyslave.w]{11}A four-byte instruction has the binary form
...
\M[226 polyslave.w]{12}The \PB{\\{get\_inst}} routine reads the next
...
\M[265 polyslave.w]{13}\B\X13:Change the source or target address and \PB{%
\&{goto} \\{restart}}\X${}\E{}$\6
${}\{{}$\1\6
...
\M[279 polyslave.w]{14}\B\X5:Global variables\X${}\mathrel+\E{}$\6
...
\M[285 polyslave.w]{15}The first six bytes of the instruction file are,
however, special.
...
\M[318 polyslave.w]{16}\B\X5:Global variables\X${}\mathrel+\E{}$\6
...
\N[328 polyslave.w]{1}{17}Servitude. This program is so easy to write, I could
even have
...
\M[346 polyslave.w]{18}\B\X6:Local variables\X${}\mathrel+\E{}$\6
\&{register} \&{int} \|p;\C{ parameter of the current instruction }\6
\&{register} \&{unsigned} \&{int} \|a;\C{ an accumulator for arithmetic }\par
\fi

\M[350 polyslave.w]{19}\B\X19:Clear \PB{\|p} counters\X${}\E{}$\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\|p;{}$ ${}\|k\PP){}$\1\5
${}\\{count}[\\{cur\_trg}+\|k]\K\T{0}{}$;\2\par
\U17.\fi

\M[353 polyslave.w]{20}\B\X20:Copy \PB{\|p} counters\X${}\E{}$\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\|p;{}$ ${}\|k\PP){}$\1\5
${}\\{count}[\\{cur\_trg}+\|k]\K\\{count}[\\{cur\_src}+\|k]{}$;\2\par
\U17.\fi

\M[356 polyslave.w]{21}I wonder what kind of machine language code my \CEE/
compiler
...
\M[366 polyslave.w]{22}The \PB{\\{sync}} instruction, at least, gives me a
...
\M[375 polyslave.w]{23}\B\X23:Check that \PB{\|p} has the correct value\X${}%
\E{}$\6
\&{if} ${}(\|p\E\T{255}){}$\1\5
...
\M[383 polyslave.w]{24}\B\X24:Output the relevant counters for completed
polyominoes\X${}\E{}$\6
...
\M[397 polyslave.w]{25}\B\X25:Print statistics\X${}\E{}$\6
...
\N[405 polyslave.w]{1}{26}Checkpointing. {\mc POLYNUM} issues the special
command \PB{\\{sync}}~255
...
\M[425 polyslave.w]{27}\B\X27:Dump all information needed to restart\X${}\E{}$\6
...
\M[439 polyslave.w]{28}\B\X5:Global variables\X${}\mathrel+\E{}$\6
\&{unsigned} \&{int} \\{dump\_data}[\T{5}];\C{ parameters needed to restart }\6
\&{FILE} ${}{*}\\{out\_file}{}$;\par
\fi

\M[443 polyslave.w]{29}For the record, here are three shell scripts called %
\.{nums},
