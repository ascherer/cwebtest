...
\N[3 horn-count.w]{1}{1}Intro. Counting closure operators on six elements that
are nonisomorphic
...
\M[40 horn-count.w]{2}\B\X2:Find all the solutions\X${}\E{}$\6
$\|l\K\\{logptr}\K\T{0};{}$\6
${}\\{auts}\K\\{nfactorial};{}$\6
\4\\{newlevel}:\5
...
\M[79 horn-count.w]{3}Algorithm 7.2.1.2T.
...
\M[105 horn-count.w]{4}\B\X4:Put all permutations into \PB{\\{wait}[\T{0}]}%
\X${}\E{}$\6
\&{for} ${}(\|p\K\T{1};{}$ ${}\|p<\\{nfactorial};{}$ ${}\|p\PP){}$\1\5
${}\\{link}[\|p]\K\\{wait}[\T{0}],\39\\{wait}[\T{0}]\K\|p{}$;\2\par
\U1.\fi

\M[108 horn-count.w]{5}\B\X5:Reject \PB{\|l} if it violates closure\X${}\E{}$\6
...
\M[114 horn-count.w]{6}\B\X6:Record a solution\X${}\E{}$\6
${}\{{}$\1\6
${}\\{sols}\PP;{}$\6
...
\N[126 horn-count.w]{1}{7}The interesting part. When writing this program, I
didn't have to work
...
\M[139 horn-count.w]{8}The basic idea is simple: Each closure operation
corresponds to
...
\M[173 horn-count.w]{9}Okay, now let me write the most critical part of the
program.
...
\M[214 horn-count.w]{10}After we've made it through \PB{\\{wait}[\|l]}, we are
able to set
...
\M[232 horn-count.w]{11}Here I've made a point to ``undo'' in precisely the
reverse order
...
\M[262 horn-count.w]{12}\B\X12:Reject \PB{\|l} immediately\X${}\E{}$\6
${}\{{}$\1\6
${}\|t\K\|p;{}$\6
\&{goto} \\{kludge};\6
\4${}\}{}$\2\par
...
\M[268 horn-count.w]{13}\B\X13:Downdate \PB{\\{wait}[\T{0}]}\X${}\E{}$\6
$\|t\K\T{0};{}$\6
...
\M[278 horn-count.w]{14}\B\X14:Check for new forced moves\X${}\E{}$\6
...
\M[289 horn-count.w]{15}\B\X15:Uncheck for new forced moves\X${}\E{}$\6
...
\M[298 horn-count.w]{16}Finally, here's a routine that documents the main
invariant
...
\M[322 horn-count.w]{17}\B\X17:Sanity check the wait lists\X${}\E{}$\6
...
\M[347 horn-count.w]{18}The wait lists \PB{\\{wait}[\|k]} for $1\le k<l$ are
...
\M[388 horn-count.w]{19}\B\X19:Sanity check \PB{\\{wait}[\T{0}]}\X${}\E{}$\6
\&{for} ${}(\|p\K\\{wait}[\T{0}];{}$ \|p; ${}\|p\K\\{link}[\|p]){}$\5
${}\{{}$\1\6
${}\\{stamp}[\|p]\K\\{timestamp};{}$\6
