...
\N[4 hulltr.w]{1}{1}Introduction. This is a hastily written implementation of
...
\M[31 hulltr.w]{2}I'm instrumenting this in a simple way.
...
\N[41 hulltr.w]{1}{3}Data structures.
...
\M[64 hulltr.w]{4}\B\X4:Initialize the array of nodes\X${}\E{}$\6
...
\M[69 hulltr.w]{5}\B\X2:Global variables\X${}\mathrel+\E{}$\6
...
\M[75 hulltr.w]{6}We assume that the vertices have been given to us in a
GraphBase-type
...
\M[97 hulltr.w]{7}We'll probably need a bunch of local variables to do
...
\M[105 hulltr.w]{8}Here's a routine I used when debugging (in fact I should
have written
...
\M[123 hulltr.w]{9}\B\X9:Procedures\X${}\E{}$\6
\&{int} \\{count};\7
\\{inorder}(\|p)\1\1\6
\&{node} ${}{*}\|p;\2\2{}$\6
${}\{{}$\1\6
...
\N[138 hulltr.w]{1}{10}Hull updating.
...
\M[157 hulltr.w]{11}Let me do the easy part first, since it's bedtime and I can
worry about
the rest tomorrow.
...
\M[168 hulltr.w]{12}In Case 1 we don't need the tree structure since we've
already found
...
\M[194 hulltr.w]{13}At this point \PB{$\|q\E\\{head}\MG\\{pred}$} is the tree's
rightmost node.
...
\M[209 hulltr.w]{14}The link from parent to child hasn't been set when the
priorities
...
\M[243 hulltr.w]{15}Nodes don't need to be recycled.
...
\M[268 hulltr.w]{16}\B\X9:Procedures\X${}\mathrel+\E{}$\6
...
\M[296 hulltr.w]{17}\B\X17:Do Case 2\X${}\E{}$\6
${}\{{}$\5
...
\M[342 hulltr.w]{18}\B\X18:Insert \PB{\\{vv}} in tree, linked by \PB{\\{ppar}}%
\X${}\E{}$\6
${}\{{}$\1\6
${}\\{tt}\K\\{next\_node}\PP;{}$\6
${}\|o,\39\\{tt}\MG\\{vert}\K\\{vv};{}$\6
...
\N[355 hulltr.w]{1}{19}Determinants. I need code for the primitive function %
\PB{\\{ccw}}.
