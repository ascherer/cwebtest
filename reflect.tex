...
\M[3 reflect.w]{1}This is a quick program to find all canonical forms of
reflection networks
for small $n$.
...
\M[40 reflect.w]{2}There's an array $a[1\mathrel{.\,.}n]$ containing $k$
inversions; an
...
\M[63 reflect.w]{3}The value of \PB{\|n} is supposed to be an argument.
...
\M[82 reflect.w]{4}\B\X4:Initialize\X${}\E{}$\6
...
\M[92 reflect.w]{5}\B\X5:Run through all canonical reflection networks\X${}%
\E{}$\6
\4\\{moveleft}:\5
${}\|j\MM;{}$\6
\4\\{loop}:\6
...
\M[105 reflect.w]{6}\B\X6:Backtrack, either going to \PB{\\{loop}} or to \PB{%
\\{finished}} when all possibilities are exhausted\X${}\E{}$\6
\&{while} ${}(\|c[\MM\|l]){}$\5
${}\{{}$\1\6
${}\|j\K\|t[\|l];{}$\6
\\{swap}(\|j);\6
...
\M[119 reflect.w]{7}\B\X7:Print a solution\X${}\E{}$\6
${}\{{}$\6
\8\#\&{ifdef} \.{DEBUG}\1\6
...
\M[137 reflect.w]{8}Here's part of the program I wrote after getting the above
to work.
...
\M[154 reflect.w]{9}\B\X9:Check if it gives a new CC system on \PB{$\|n+\T{1}$}
elements\X${}\E{}$\6
...
\M[169 reflect.w]{10}\B\X10:Shift the first transposition to the other end\X${}%
\E{}$\6
$\|j\K\|n-\|b[\|r\PP];{}$\6
...
\M[175 reflect.w]{11}\B\X11:Test lexicographic order; \PB{\&{break}} if equal
or less\X${}\E{}$\6
${}\{{}$\1\6
...
\M[191 reflect.w]{12}Well, after I got that going I couldn't resist continuing
until I had
...
\M[219 reflect.w]{13}For this part of the program we use an array \PB{\|x}
analogous to \PB{\|b}; also
...
\M[233 reflect.w]{14}At this point \PB{$\|i-\|r$} points just past the end of
the \PB{\|d} data, and
...
\M[242 reflect.w]{15}One nice thing is that reflection and turning upside down
preserve
...
\M[269 reflect.w]{16}\B\X16:Replace the present \PB{\|x} by the reverse of \PB{%
\|y}\X${}\E{}$\6
${}\{{}$\1\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\\{rrr};{}$ ${}\|i\PP){}$\1\5
...
\M[280 reflect.w]{17}\B\X17:If the new network is weakly equivalent to a
lexicographically smaller one, \PB{\&{goto} \\{done}}\X${}\E{}$\6
\&{for} ${}(\|i\K\|s+\|n;{}$ ${}\|i<\\{ss};{}$ ${}\|i\PP){}$\1\5
${}\|e[\|i-\|s]\K\|x[\|i];{}$\2\6
...
\M[296 reflect.w]{18}\B\X18:If the \PB{\|x} network is weakly equivalent to an
earlier one, \PB{\&{goto} \\{done}}; if weakly equivalent to the present one, %
\PB{\&{goto} \\{okay}}\X${}\E{}$\6
$\|x[\\{ss}]\K\T{0}{}$;\C{ sentinel }\6
\&{for} ${}(\|i\K\|s+\|n;{}$ ${}\|x[\|i]\E\|d[\|i-\|s];{}$ ${}\|i\PP){}$\1\5
...
\M[303 reflect.w]{19}\B\X19:End-around shift \PB{\|x}\X${}\E{}$\6
${}\{{}$\1\6
${}\|j\K\|n-\|x[\|s\PP];{}$\6
...
\M[311 reflect.w]{20}The only somewhat tricky operation comes in here. We use
the fact that
...
\M[356 reflect.w]{21}We must carry over items that exceed \PB{\|m}, which
denotes the maximum
...
\M[369 reflect.w]{22}The score is computed in several passes, although I do
know how to
...
\M[390 reflect.w]{23}As we fill the cell counts, we assume that \PB{\|x[%
\\{ii}]} is the previous cell
...
\M[410 reflect.w]{24}\B\X24:If debugging, print the active region of \PB{\|b}%
\X${}\E{}$\6
\8\#\&{ifdef} \.{DEBUG}\6
\\{printf}(\.{"\\n>"});\6
...
\M[416 reflect.w]{25}\B\X25:If debugging, print the active region of \PB{\|x}%
\X${}\E{}$\6
\8\#\&{ifdef} \.{DEBUG}\6
\\{printf}(\.{"\\n\ \ "});\6
