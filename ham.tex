...
\N[5 ham.w]{1}{1}Hamiltonian cycles. This program finds all Hamiltonian cycles
of
...
\M[50 ham.w]{2}\B\X2:Process the command line, inputting the graph\X${}\E{}$\6
\&{if} ${}(\\{argc}>\T{1}){}$\1\5
...
\M[58 ham.w]{3}Vertices that have already appeared in the path are ``taken,''
and
...
\N[73 ham.w]{1}{4}The data structures. I use one simple rule to cut off
unproductive
...
\M[104 ham.w]{5}\B\X5:Increase \PB{\|t} and update the data structures to show
...
\M[128 ham.w]{6}\B\X6:Downdate the data structures to the state they were in
...
\M[132 ham.w]{7}\B\X7:Look at edge \PB{\|a} and its successors, advancing if it
...
\M[143 ham.w]{8}\B\X8:Decrease \PB{\|t}, if possible, and try the next
possibility; or \PB{\&{goto} \\{done}}\X${}\E{}$\6
...
\M[153 ham.w]{9}\B\X9:Record a solution\X${}\E{}$\6
${}\{{}$\1\6
${}\\{count}\PP;{}$\6
