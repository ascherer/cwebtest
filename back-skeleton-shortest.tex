...
\N[3 back-skeleton-shortest.w]{1}{1}Intro. This program is designed to compose
multiplication-skeleton puzzles
...
\M[47 back-skeleton-shortest.w]{2}The examples above show that zeros in the
multiplier will ``offset''
...
\M[98 back-skeleton-shortest.w]{3}\B\X3:Process the command line\X${}\E{}$\6
...
\M[118 back-skeleton-shortest.w]{4}\B\X4:Input the pattern\X${}\E{}$\6
...
\M[136 back-skeleton-shortest.w]{5}\B\X5:Input row \PB{\|n} of the shape\X${}%
\E{}$\6
...
\N[148 back-skeleton-shortest.w]{1}{6}Bignums. We implement elementary decimal
...
\M[156 back-skeleton-shortest.w]{7}For example, it's easy to test equality of
two such bignums,
...
\M[172 back-skeleton-shortest.w]{8}Here's the basic routine. It's OK to have %
\PB{$\|a\K\|b$} or \PB{$\|b\K\|c$}.
...
\M[198 back-skeleton-shortest.w]{9}\B\X7:Subroutines\X${}\mathrel+\E{}$\6
...
\M[206 back-skeleton-shortest.w]{10}We might as well have a primitive
...
\M[213 back-skeleton-shortest.w]{11}\B\X11:Global variables\X${}\E{}$\6
\&{bignum} \\{cnst}[\T{82}];\par
\As17, 21\ETs40.
\U2.\fi

\N[216 back-skeleton-shortest.w]{1}{12}Offsets and constraints.
...
\M[239 back-skeleton-shortest.w]{13}\B\X13:Establish the minimum offsets\X${}%
\E{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\|m;{}$ ${}\|i\PP){}$\1\5
${}\|o,\39\\{off}[\|i]\K\|i{}$;\2\par
\U2.\fi

\M[242 back-skeleton-shortest.w]{14}The offset table runs through all
...
\M[252 back-skeleton-shortest.w]{15}We must choose the position \PB{\\{pos}}
...
\M[270 back-skeleton-shortest.w]{16}Sometimes two constraints are identical,
...
\M[289 back-skeleton-shortest.w]{17}\B\X11:Global variables\X${}\mathrel+\E{}$\6
...
\M[295 back-skeleton-shortest.w]{18}\B\X18:Create detailed specifications from
the pattern\X${}\E{}$\6
${}\{{}$\1\6
...
\N[312 back-skeleton-shortest.w]{1}{19}Backtracking.
...
\M[377 back-skeleton-shortest.w]{20}Such considerations lead us to a standard
backtracking scheme
...
\M[415 back-skeleton-shortest.w]{21}What data structures will support this
computation nicely?
...
\M[443 back-skeleton-shortest.w]{22}\B\X22:Initialize the data structures\X${}%
\E{}$\6
...
\M[453 back-skeleton-shortest.w]{23}\B\X23:Print the \PB{\\{csize}} status
information\X${}\E{}$\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\|m;{}$ ${}\|k\PP){}$\1\5
...
\M[458 back-skeleton-shortest.w]{24}\B\D$\\{thresh}$ \5
\T{25}\par
...
\M[480 back-skeleton-shortest.w]{25}Now we've come to the heart and soul of the
program. As we test
...
\M[503 back-skeleton-shortest.w]{26}We've previously verified constraint \PB{%
\|k} in the least significant
...
\M[517 back-skeleton-shortest.w]{27}\B\X27:Delete \PB{\\{choice}[\|k][\T{0}]}
...
\M[530 back-skeleton-shortest.w]{28}The data structures that I've got don't
...
\M[538 back-skeleton-shortest.w]{29}Downdating seems to be completely
...
\M[544 back-skeleton-shortest.w]{30}\B\X30:If all constraints are totally
...
\M[555 back-skeleton-shortest.w]{31}\B\X31:If constraint $c_k$ isn't totally
satisfied, \PB{\&{goto} \\{nope}}\X${}\E{}$\6
${}\{{}$\1\6
...
\M[565 back-skeleton-shortest.w]{32}\B\X32:If constraint $c_m$ isn't totally
satisfied, \PB{\&{goto} \\{nope}}\X${}\E{}$\6
...
\M[575 back-skeleton-shortest.w]{33}When a solution is found, I first print out
the lengths of
...
\M[601 back-skeleton-shortest.w]{34}It's conceivable that we've constructed a
...
\N[640 back-skeleton-shortest.w]{1}{35}An inner loop. When we're testing the
...
\M[685 back-skeleton-shortest.w]{36}\B\X36:Run through all $m$-tuples $g_0%
\ldots g_{m-1}$\X${}\E{}$\6
\4\\{bb1}:\5
${}\|k\K\T{0};{}$\6
\4\\{bb2}:\5
...
\M[697 back-skeleton-shortest.w]{37}\B\X37:Set \PB{\\{acc}[\|k]} to the least
...
\M[706 back-skeleton-shortest.w]{38}\B\X38:Test compliance with $c_m$ and \PB{%
\&{goto} \\{bb5}}\X${}\E{}$\6
${}\{{}$\1\6
...
\M[723 back-skeleton-shortest.w]{39}\B\X39:Remove items from \PB{\\{choice}[%
\|k]}\X${}\E{}$\6
${}\{{}$\1\6
...
\M[739 back-skeleton-shortest.w]{40}\B\X11:Global variables\X${}\mathrel+\E{}$\6
...
\N[744 back-skeleton-shortest.w]{1}{41}Index.
\fi
