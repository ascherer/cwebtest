...
\N{1}{1}Intro. This simple program calculates Schensted's Y function.
Consider the array
...
\M{2}\B\X2:Read the input into a[0], determining \PB{\|n}\X${}\E{}$\6
...
\M{3}\B\X3:Compute \PB{\|a[\|k]} from \PB{$\|a[\|k-\T{1}]$}\X${}\E{}$\6
...
\M{4}\B\X4:Print the results\X${}\E{}$\6
