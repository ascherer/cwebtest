...
\N{1}{1}Antisliding blocks. This program illustrates techniques of finding all
...
\N{1}{3}Data structures. An exact cover problem is defined by a matrix $M$ of
0s
...
\M{4}Each column corresponds to a cell of the array. Special information for
...
\M{5}One \PB{\&{cell}} struct is called the root. It serves as the head of the
...
\M{6}The rows of $M$ also have special data structures:
...
\N{1}{7}Initialization. Like most table-driven programs, this one needs to
...
\M{8}\B\X8:Set up data structures for antisliding blocks\X${}\E{}$\6
\X9:Set up the cells\X;\6
\X11:Set up the options\X;\6
\X15:Set up the nodes\X;\par
\U1.\fi

\M{9}\B\X9:Set up the cells\X${}\E{}$\6
$\|q\K{\AND}\\{root};{}$\6
...
\M{10}\B\X10:Fill in the symmetry pointers of \PB{\|c}\X${}\E{}$\6
...
\M{17}\B\X17:Set up the \PB{\\{blocky}} nodes\X${}\E{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\\{ll}-\T{1};{}$ ${}\|i\PP){}$\1\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j<\\{mm};{}$ ${}\|j\PP){}$\1\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\\{nn}-\T{1};{}$ ${}\|k\PP){}$\5
${}\{{}$\1\6
...
\M{18}\B\X18:Set up the \PB{\\{blockz}} nodes\X${}\E{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\\{ll}-\T{1};{}$ ${}\|i\PP){}$\1\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j<\\{mm}-\T{1};{}$ ${}\|j\PP){}$\1\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\\{nn};{}$ ${}\|k\PP){}$\5
${}\{{}$\1\6
...
\M{20}\B\X20:Map to \PB{\\{blockx}} nodes\X${}\E{}$\6
\&{for} ${}(\|t\K\T{0};{}$ ${}\|t<\T{4};{}$ ${}\|t\PP){}$\5
${}\{{}$\1\6
${}\|q\K\\{pp}[\|t].\\{col}\MG\\{head}.\\{sym}[\|s]\MG\\{col}\MG\\{name};{}$\6
${}\|i\K\|q[\T{0}]-\.{'0'};{}$\6
...
\M{21}\B\X21:Map to \PB{\\{blocky}} nodes\X${}\E{}$\6
\&{for} ${}(\|t\K\T{0};{}$ ${}\|t<\T{4};{}$ ${}\|t\PP){}$\5
${}\{{}$\1\6
${}\|q\K\\{pp}[\|t].\\{col}\MG\\{head}.\\{sym}[\|s]\MG\\{col}\MG\\{name};{}$\6
${}\|i\K\|q[\T{0}]-\.{'0'};{}$\6
...
\M{22}\B\X22:Map to \PB{\\{blockz}} nodes\X${}\E{}$\6
\&{for} ${}(\|t\K\T{0};{}$ ${}\|t<\T{4};{}$ ${}\|t\PP){}$\5
${}\{{}$\1\6
${}\|q\K\\{pp}[\|t].\\{col}\MG\\{head}.\\{sym}[\|s]\MG\\{col}\MG\\{name};{}$\6
${}\|i\K\|q[\T{0}]-\.{'0'};{}$\6
...
\N{1}{23}Backtracking and isomorph rejection.
...
\M{24}\B\X24:Local variables\X${}\E{}$\6
...
\M{25}As usual, I'm using labels and \PB{\&{goto}} statements as I backtrack,
...
\M{26}The usual trick in backtracking is to update the data structures in such
a
...
\M{27}Here's a subroutine that removes all options that cover cell~\PB{\|c}
from all
...
\M{28}Uncovering is done in precisely the reverse order. The pointers thereby
...
\M{29}\B\X29:Remove options that cover cells other than \PB{\\{best\_cell}[%
\|l]}\X${}\E{}$\6
...
\M{30}\B\X30:Unremove options that cover cells other than \PB{\\{best\_cell}[%
\|l]}\X${}\E{}$\6
...
\M{31}\B\X31:Select \PB{$\|c\K\\{best\_cell}[\|l]$}, or \PB{\&{goto} %
\\{solution}} if all cells are covered\X${}\E{}$\6
$\|q\K\\{root}.\\{next};{}$\6
\&{if} ${}(\|q\E{\AND}\\{root}){}$\1\5
\&{goto} \\{solution};\2\6
...
\M{32}\B\X32:Mark the newly covered elements\X${}\E{}$\6
\&{for} ${}(\|p\K\\{move}[\|l]\MG\\{right};{}$ ${}\|p\I\\{move}[\|l];{}$ ${}\|p%
\K\|p\MG\\{right}){}$\5
${}\{{}$\1\6
...
\M{33}\B\X33:Unmark the newly covered elements\X${}\E{}$\6
\&{for} ${}(\|p\K\\{move}[\|l]\MG\\{left};{}$ ${}\|p\I\\{move}[\|l];{}$ ${}\|p%
\K\|p\MG\\{left}){}$\5
${}\{{}$\1\6
...
\M{34}\B\X34:Compute the new constraint list; \PB{\&{goto} \\{unmark}} if
...
\M{35}\B\X35:Delete current cell from the constraint list, possibly forcing
...
\M{36}\B\X36:Force \PB{\\{constraint}[\\{kk}]} to be nonempty\X${}\E{}$\6
${}\{{}$\1\6
${}\|k\K\\{kk};{}$\6
${}\|q\K\\{constraint}[\|k];{}$\6
...
\M{37}\B\X37:Add new constraints; \PB{\&{goto} \\{unmark}} if previous choices
...
\M{38}\B\X38:Copy former constraints that are still unsatisfied\X${}\E{}$\6
\&{while} ${}(\|j<\\{constraint\_ptr}[\|l]){}$\5
${}\{{}$\1\6
${}\\{kk}\K\|k;{}$\6
\&{while} ${}((\|q\K\\{constraint}[\|j])){}$\5
...
\M{39}\B\X39:Delete the new forcing table entries\X${}\E{}$\6
...
\M{40}\B\X40:Compute the new symcheck list; \PB{\&{goto} \\{unmark}} if $a_1%
...
\M{41}\B\X41:Set $a_l$ to the empty option of \PB{\|c}; \PB{\&{goto} \\{try%
\_again}} if that option isn't allowed\X${}\E{}$\6
$\\{move}[\|l]\K{\AND}(\|c\MG\\{head});{}$\6
\&{if} ${}(\|c\MG\\{nonempty}){}$\1\5
\&{goto} \\{try\_again};\2\par
\U26.\fi

\M{42}\B\X42:Record a solution\X${}\E{}$\6
$\\{count}\PP;{}$\6
\&{if} (\\{verbose})\5
${}\{{}$\1\6
...
\M{43}\B\X19:Subroutines\X${}\mathrel+\E{}$\6
\\{print\_move}(\|p)\1\1\6
\&{node} ${}{*}\|p;\2\2{}$\6
${}\{{}$\1\6
\&{register} \&{node} ${}{*}\|q;{}$\7
...
\M{44}\B\X44:Handle diagnostic info\X${}\E{}$\6
${}\{{}$\1\6
${}\\{profile}[\|l]\PP;{}$\6
...
\M{45}\B\X45:Print a profile of the search tree\X${}\E{}$\6
${}\{{}$\1\6
...
\M{46}\B\X46:Initialize for level 0\X${}\E{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\\{ll};{}$ ${}\|i\PP){}$\1\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j<\\{mm};{}$ ${}\|j\PP){}$\1\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\\{nn};{}$ ${}\|k\PP){}$\5
${}\{{}$\1\6
...
\M{47}\B\X47:Make redundancy checks to see if the backtracking was consistent%
\X${}\E{}$\6
$\|q\K{\AND}\\{root};{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i<\\{ll};{}$ ${}\|i\PP){}$\1\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j<\\{mm};{}$ ${}\|j\PP){}$\1\6
