...
\N[1 back-mxn-words-mxn.w]{1}{1}An example of backtracking. Given a list of
...
\M[58 back-mxn-words-mxn.w]{2}\B\X2:Print the profile\X${}\E{}$\6
$\\{fprintf}(\\{stderr},\39\.{"Profile:\ \ \ \ \ \ \ \ \ \ 1}\)\.{\\n"});{}$\6
\&{for} ${}(\|k\K\T{2};{}$ ${}\|k\Z\|m*\|n+\T{1};{}$ ${}\|k\PP){}$\1\5
${}\\{fprintf}(\\{stderr},\39\.{"\%19lld\\n"},\39\\{profile}[\|k]){}$;\2\par
\U1.\fi

\M[62 back-mxn-words-mxn.w]{3}\B\X3:Process the command line\X${}\E{}$\6
\&{if} ${}(\\{argc}\I\T{3}){}$\5
${}\{{}$\1\6
...
\M[92 back-mxn-words-mxn.w]{4}\B\X4:Input the $m$-words and make the tri\X${}%
\E{}$\6
$\|m\K\\{mm}\K\T{0};{}$\6
\&{while} (\T{1})\5
${}\{{}$\1\6
...
\M[118 back-mxn-words-mxn.w]{5}For simplicity, I make a sparse trie with 27
...
\M[161 back-mxn-words-mxn.w]{6}\B\X6:Check the length of the new line\X${}\E{}$%
\6
\&{if} ${}(\|n\E\T{0}){}$\5
${}\{{}$\1\6
${}\|n\K\|j;{}$\6
...
\M[181 back-mxn-words-mxn.w]{7}In this program I build what's called here
...
\M[212 back-mxn-words-mxn.w]{8}With a small change (namely to cache the value
...
\M[237 back-mxn-words-mxn.w]{9}Here I follow Algorithm 7.2.2B.
...
\M[267 back-mxn-words-mxn.w]{10}\B\X10:Print a solution and \PB{\&{goto} %
\\{b5}}\X${}\E{}$\6
${}\{{}$\1\6
${}\\{count}\PP{}$;\5
${}\\{printf}(\.{"\%d:"},\39\\{count});{}$\6
...
\M[278 back-mxn-words-mxn.w]{11}\B\X11:Report the current state, if \PB{$%
\\{mems}\G\\{thresh}$}\X${}\E{}$\6
\&{if} ${}(\\{mems}\G\\{thresh}){}$\5
${}\{{}$\1\6
...
\N[286 back-mxn-words-mxn.w]{1}{12}Index.
\fi
