...
\N[2 antislide.w]{1}{1}Introduction. This program finds all ways to pack $2%
\times2\times1$ bricks
...
\N[40 antislide.w]{1}{2}Data structures. This program deals chiefly with three
kinds of lists,
...
\M[73 antislide.w]{3}The sizes of the basic arrays were determined
...
\M[84 antislide.w]{4}Here's how we get everything started, when packing bricks
as mentioned above.
...
\M[104 antislide.w]{5}\B\X5:Make all cell lists empty\X${}\E{}$\6
...
\M[112 antislide.w]{6}\B\D$\\{new\_node}(\\{ii},\\{jj},\\{kk})$ \6
${}\{{}$\1\6
...
\M[149 antislide.w]{7}\B\X7:Initialize all moves that have constant second
coordinate\X${}\E{}$\6
...
\M[172 antislide.w]{8}\B\X8:Initialize all moves that have constant third
coordinate\X${}\E{}$\6
\&{for} ${}(\|i\K\T{0};{}$ ${}\|i+\T{1}<\\{n1};{}$ ${}\|i\PP){}$\1\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j+\T{1}<\\{n2};{}$ ${}\|j\PP){}$\1\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\\{n3};{}$ ${}\|k\PP){}$\5
...
\M[195 antislide.w]{9}\B\X9:Print the move that starts with \PB{\\{first%
\_node}}\X${}\E{}$\6
${}\{{}$\1\6
\&{node} ${}{*}{*}\\{p1},{}$ ${}{*}{*}{*}\\{c1};{}$\7
...
\N[209 antislide.w]{1}{10}Backtracking. At level \PB{\|l}, we've made \PB{\|l}
...
\M[227 antislide.w]{11}I'm using \PB{\&{goto}} statements, as usual when I
backtrack.
...
\M[263 antislide.w]{12}\B\X12:Find a constraint to branch on, and put its moves
...
\M[274 antislide.w]{13}Here's where the tag fields become important. Pay
attention now.
...
\M[296 antislide.w]{14}\B\D$\\{panic}(\|s)$ \6
${}\{{}$\1\6
...
\M[305 antislide.w]{15}Here I'm sorta cheating. Strictly speaking, this problem
has no
...
\M[317 antislide.w]{16}This step changes \PB{\\{pp}}, inside of section \PB{$%
...
\M[335 antislide.w]{17}When a cell is occupied by the move at level \PB{\|l},
we put \PB{$\|l+\T{1}$} into
...
\M[354 antislide.w]{18}\B\X18:If constraint \PB{$\\{pp}\K{*}\\{cc}$} is not
...
\M[360 antislide.w]{19}The links do their dance in this step. We have to
...
\M[377 antislide.w]{20}\B\X20:Unremove all other moves in the cell list
containing \PB{\|p} from their other cell lists\X${}\E{}$\6
...
\M[387 antislide.w]{21}\B\X21:Disallow move \PB{${*}\\{pp}$}\X${}\E{}$\6
...
\M[394 antislide.w]{22}\B\X22:Reinstate all moves from this level\X${}\E{}$\6
...
\M[402 antislide.w]{23}\B\X23:Put all remaining moves on the move stack\X${}%
\E{}$\6
${}\{{}$\1\6
${}\\{stamp}\PP;{}$\6
...
\M[410 antislide.w]{24}\B\X24:Print a progress report\X${}\E{}$\6
${}\{{}$\1\6
...
\M[420 antislide.w]{25}\B\X25:Record a solution\X${}\E{}$\6
$\\{totsols}[\|l]\PP;{}$\6
\&{if} (\\{verbose})\5
${}\{{}$\1\6
\&{int} \\{ii}${},{}$ \\{jj}${},{}$ \\{kk};\7
...
\M[435 antislide.w]{26}\B\X26:Report the answers\X${}\E{}$\6
