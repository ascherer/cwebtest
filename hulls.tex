...
\N[4 hulls.w]{1}{1}Introduction. This is a hastily written implementation of
hull insertion.
...
\M[28 hulls.w]{2}I'm instrumenting this in a simple way.
...
\N[38 hulls.w]{1}{3}Data structures.
...
\M[54 hulls.w]{4}\B\X2:Global variables\X${}\mathrel+\E{}$\6
\&{Vertex} ${}{*}\\{rover}{}$;\C{ one of the vertices in the convex hull }\par
\fi

\M[57 hulls.w]{5}We assume that the vertices have been given to us in a
GraphBase-type
...
\M[70 hulls.w]{6}We'll probably need a bunch of local variables to do
...
\N[76 hulls.w]{1}{7}Hull updating.
...
\M[92 hulls.w]{8}Let me do the easy part first, since it's bedtime and I can
worry about
the rest tomorrow.
...
\M[103 hulls.w]{9}\B\X9:Go around the current hull; \PB{\&{continue}} if \PB{%
\\{vv}} is inside it\X${}\E{}$\6
$\|u\K\\{rover};{}$\6
\&{do}\5
${}\{{}$\1\6
...
\M[113 hulls.w]{10}\B\X10:Update the convex hull, knowing that \PB{\\{vv}} lies
...
\N[134 hulls.w]{1}{11}Determinants. I need code for the primitive function \PB{%
\\{ccw}}.
