...
\N[2 dance.w]{1}{1}Generalized exact cover.
...
\M[50 dance.w]{2}\B\X2:Global variables\X${}\E{}$\6
...
\N[60 dance.w]{1}{3}Data structures.
...
\M[83 dance.w]{4}Each \&{column} struct contains five fields:
...
\M[104 dance.w]{5}One \PB{\&{column}} struct is called the root. It serves as
the head of the
...
\M[110 dance.w]{6}A row is identified not by name but by the names of the
columns it contains.
...
\N[136 dance.w]{1}{7}Inputting the matrix.
...
\M[143 dance.w]{8}\B\D$\\{buf\_size}$ \5
...
\M[180 dance.w]{10}\B\X10:Local variables\X${}\E{}$\6
...
\M[186 dance.w]{11}\B\X11:Read the rows\X${}\E{}$\6
...
\N[215 dance.w]{1}{12}Backtracking.
...
\M[286 dance.w]{16}Uncovering is done in precisely the reverse order. The
pointers thereby
...
\M[305 dance.w]{17}\B\X17:Cover all other columns of \PB{\\{cur\_node}}\X${}%
\E{}$\6
...
\M[308 dance.w]{18}We included \PB{\\{left}} links, thereby making the rows
doubly linked, so
...
\M[316 dance.w]{19}\B\X19:Set \PB{\\{best\_col}} to the best column for
branching\X${}\E{}$\6
...
\M[336 dance.w]{20}\B\X10:Local variables\X${}\mathrel+\E{}$\6
\&{register} \&{int} \\{minlen};\6
\&{register} \&{int} \|j${},{}$ \|k${},{}$ \|x;\par
\fi

\M[340 dance.w]{21}\B\X21:Record solution and \PB{\&{goto} \\{recover}}\X${}%
\E{}$\6
${}\{{}$\1\6
${}\\{count}\PP;{}$\6
\&{if} (\\{verbose})\5
...
\M[353 dance.w]{22}\B\X22:Print column lengths, to make sure everything has
been restored\X${}\E{}$\6
${}\{{}$\1\6
...
\M[361 dance.w]{23}\B\X23:Print a profile of the search tree\X${}\E{}$\6
${}\{{}$\1\6
\&{double} \\{tot}${},{}$ \\{subtot};\7
