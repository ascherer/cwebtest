...
\N[2 polyominoes.w]{1}{1}Data for dancing. This program creates data suitable
for the {\mc DANCE}
...
\M[69 polyominoes.w]{2}\B\D$\\{panic}(\|m)$ \6
${}\{{}$\5
...
\M[93 polyominoes.w]{3}\B\X3:Subroutines\X${}\E{}$\6
\&{int} \\{decode}(\|c)\1\1\6
\&{char} \|c;\2\2\6
${}\{{}$\1\6
\&{if} ${}(\|c\Z\.{'9'}){}$\5
...
\M[105 polyominoes.w]{4}\B\X4:Global variables\X${}\E{}$\6
...
\M[110 polyominoes.w]{5}\B\X5:Read and output the piece names\X${}\E{}$\6
...
\M[114 polyominoes.w]{6}\B\X6:Read and output the pieces\X${}\E{}$\6
...
\M[150 polyominoes.w]{7}\B\X4:Global variables\X${}\mathrel+\E{}$\6
...
\M[156 polyominoes.w]{8}\B\X8:Generate the possible piece placements\X${}\E{}$\6
\&{while} (\|t)\5
${}\{{}$\1\6
...
\M[166 polyominoes.w]{9}\B\X9:Transpose the current piece\X${}\E{}$\6
...
\M[175 polyominoes.w]{10}\B\X10:Rotate the current piece\X${}\E{}$\6
\&{for} ${}(\|j\K\T{0};{}$ ${}\|j<\|n;{}$ ${}\|j\PP){}$\5
${}\{{}$\1\6
${}\|z\K\\{xx}[\|j];{}$\6
${}\\{xx}[\|j]\K\T{35}-\\{yy}[\|j];{}$\6
...
\M[183 polyominoes.w]{11}\B\X11:Output translates of the current piece\X${}%
\E{}$\6
...
\M[195 polyominoes.w]{12}\B\X3:Subroutines\X${}\mathrel+\E{}$\6
\&{char} \\{encode}(\|x)\1\1\6
\&{int} \|x;\2\2\6
${}\{{}$\1\6
\&{if} ${}(\|x<\T{10}){}$\1\5
...
\N[203 polyominoes.w]{1}{13}Index.
\fi
