...
\N[2 sudoku.w]{1}{1}Intro. Mike Spivey announced a programming contest in
February 2005,
...
\M[31 sudoku.w]{2}In a production system I would of course try to give more
...
\M[57 sudoku.w]{3}First we print out all the positions, rows, columns, and
boxes that
need to be covered.
...
\M[70 sudoku.w]{4}Then we print out all the possible placements.
