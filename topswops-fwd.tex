...
\N[2 topswops-fwd.w]{1}{1}Intro. An experimental forward method for topswops,
using
...
\M[50 topswops-fwd.w]{2}\B\X2:Go up a level, except \PB{\&{goto} \\{infeas}} if
...
\M[78 topswops-fwd.w]{3}\B\X3:Record and print the solution\X${}\E{}$\6
${}\{{}$\1\6
${}\\{score}[\|n]\K\|c;{}$\6
${}\\{printf}(\.{"\%d:"},\39\|c);{}$\6
...
\M[96 topswops-fwd.w]{4}\B\X4:Print the stats\X${}\E{}$\6
\&{for} ${}(\|k\K\T{0};{}$ ${}\|k<\|n;{}$ ${}\|k\PP){}$\1\5
${}\\{printf}(\.{"\%9d\ nodes\ at\ level\ }\)\.{\%d.\\n"},\39\\{profile}[\|k],%
\39\|k){}$;\2\par
\U1.\fi

\N[99 topswops-fwd.w]{1}{5}Index.
\fi
