...
\N[3 hyperbolic.w]{1}{1}Introduction. This program computes numerical
coordinates so that I can
...
\N[40 hyperbolic.w]{1}{2}Hyperbolic data structures. I think the most
convenient way to
...
\M[54 hyperbolic.w]{3}The unique hyperbolic line that passes through two given
points
...
\M[72 hyperbolic.w]{4}The main technical operation in this program is to
...
\M[112 hyperbolic.w]{5}As our algorithm proceeds, it will repeatedly compute
points
...
\M[163 hyperbolic.w]{6}\B\X6:Global variables\X${}\E{}$\6
...
\M[171 hyperbolic.w]{7}The main component of our data structure is the table of
all
...
\M[189 hyperbolic.w]{8}An auxiliary hash table keeps track of the triangles
we've seen.
...
\M[209 hyperbolic.w]{9}\B\X6:Global variables\X${}\mathrel+\E{}$\6
...
\N[215 hyperbolic.w]{1}{10}Getting started. To prime the pump, I need one
...
\M[231 hyperbolic.w]{11}\B\X11:Set up triangle 0\X${}\E{}$\6
...
\M[242 hyperbolic.w]{12}Edge \PB{\\{e36}} of the starting triangle is a
vertical line from
...
\N[259 hyperbolic.w]{1}{13}The algorithm. One more important thing needs to be
mentioned,
...
\M[292 hyperbolic.w]{14}\B\X14:Compute \PB{\\{t36}}\X${}\E{}$\6
${}\{{}$\1\6
...
\M[326 hyperbolic.w]{16}\B\X16:Compute \PB{\\{t90}}\X${}\E{}$\6
${}\{{}$\1\6
...
\N[343 hyperbolic.w]{1}{17}Output. Here's what we get when the circles \.{l1}, %
\.{l2}, \dots~are
plotted:
\bigskip
...
\N[348 hyperbolic.w]{1}{18}Dual output. And here's what happens when those
circles are reflected with
...
\N[353 hyperbolic.w]{1}{19}The overall tiling. Finally, the right half of the
