...
\N[6 zeilberger.w]{1}{1}Introduction. This little program implements
Zeilberger's bijection
...
\M[94 zeilberger.w]{3}\B\X3:Move to the next forest \PB{$(\|l,\|r)$}, or \PB{%
\&{break}}\X${}\E{}$\6
...
\M[142 zeilberger.w]{6}Zeilberger's bijection is recursively defined too, and
we will
...
\M[164 zeilberger.w]{8}\B\X5:Subroutines\X${}\mathrel+\E{}$\6
...
\M[288 zeilberger.w]{16}\B\X16:Undo Zeilberger's Case 3\X${}\E{}$\6
${}\{{}$\1\6
\&{if} ${}(\|s[\\{lll}[\|x]]>\T{1}){}$\5
${}\{{}$\1\6
