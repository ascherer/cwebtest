...
\N[1 sat-commafree.w]{1}{1}Intro. Find a comma-free block code of length $n$,
having one code
...
\M[22 sat-commafree.w]{2}\B\X2:Process the command line\X${}\E{}$\6
...
\M[33 sat-commafree.w]{3}Here I use Algorithm 7.2.1.1F to find the prime binary
strings.
...
\M[45 sat-commafree.w]{4}\B\X4:Visit the prime string $a_1\ldots a_n$\X${}\E{}$%
\6
${}\{{}$\1\6
...
\M[55 sat-commafree.w]{5}\B\X5:Generate the negative clauses\X${}\E{}$\6
...
\M[65 sat-commafree.w]{6}\B\X6:If \PB{\|x} is cyclic, \PB{\&{continue}}\X${}%
\E{}$\6
...
\M[71 sat-commafree.w]{7}\B\X7:If \PB{\|y} is cyclic, \PB{\&{continue}}\X${}%
\E{}$\6
...
\M[77 sat-commafree.w]{8}\B\X8:If \PB{\|z} is cyclic, \PB{\&{continue}}\X${}%
\E{}$\6
...
\M[83 sat-commafree.w]{9}\B\X9:Generate the clauses for \PB{\|x} followed by %
\PB{\|y}\X${}\E{}$\6
...
\N[92 sat-commafree.w]{1}{10}Index.
\fi
