...
\N[2 15puzzle-korf1.w]{1}{1}Introduction. This program finds a minimum-move
...
\M[57 15puzzle-korf1.w]{2}Let's regard the 16 cell positions as two-digit
...
\N[121 15puzzle-korf1.w]{1}{3}Korf's method.
...
\M[185 15puzzle-korf1.w]{4}Saving memory means that the computation lives
entirely within the
...
\M[263 15puzzle-korf1.w]{5}Enough of this introduction. Let's get on with the
program.
...
\M[279 15puzzle-korf1.w]{6}\B\X6:Set \PB{\\{moves}} to the minimum number of
happy moves\X${}\E{}$\6
...
\M[287 15puzzle-korf1.w]{7}The main control routine is a stack, which records
two things:
...
\M[293 15puzzle-korf1.w]{8}\B\X8:Switch into action\X${}\E{}$\6
\4\\{switcher}:\5
...
\M[313 15puzzle-korf1.w]{9}Directions are encoded as follows: $\rm east=0$, $%
\rm north=1$,
...
\M[335 15puzzle-korf1.w]{10}\B\X10:Cases that move east from column 0\X${}\E{}$%
\6
...
\M[376 15puzzle-korf1.w]{11}\B\X11:Cases that move east from column 1\X${}\E{}$%
\6
...
\M[441 15puzzle-korf1.w]{12}\B\X12:Cases that move east from column 2\X${}\E{}$%
\6
...
\M[506 15puzzle-korf1.w]{13}\B\X13:Cases that move west from column 1\X${}\E{}$%
\6
...
\M[572 15puzzle-korf1.w]{14}\B\X14:Cases that move west from column 2\X${}\E{}$%
\6
...
\M[638 15puzzle-korf1.w]{15}\B\X15:Cases that move west from column 3\X${}\E{}$%
\6
...
\M[679 15puzzle-korf1.w]{16}\B\X16:Cases that move north from row 1\X${}\E{}$\6
...
\M[745 15puzzle-korf1.w]{17}\B\X17:Cases that move north from row 2\X${}\E{}$\6
...
\M[811 15puzzle-korf1.w]{18}\B\X18:Cases that move north from row 3\X${}\E{}$\6
...
\M[852 15puzzle-korf1.w]{19}\B\X19:Cases that move south from row 0\X${}\E{}$\6
...
\M[893 15puzzle-korf1.w]{20}\B\X20:Cases that move south from row 1\X${}\E{}$\6
...
\M[959 15puzzle-korf1.w]{21}Yes, this has been boring. But now we're in the
last such section.
...
\M[1026 15puzzle-korf1.w]{22}The cases $(r,c,d,p)$ with $d=p$ represent the
times when we
...
\M[1175 15puzzle-korf1.w]{23}Great --- all the code has now been written for
the inner loop.
...
\M[1206 15puzzle-korf1.w]{24}Hey, we have a winner! The stack entries tell us
how we got here,
...
\N[1235 15puzzle-korf1.w]{1}{25}Index.
\fi
