...
\N[3 back-20q.w]{1}{1}Intro. This program finds all solutions to Don Woods's
Twenty Questions,
...
\M[54 back-20q.w]{2}\B\X2:Print the profile\X${}\E{}$\6
${}\{{}$\1\6
...
\M[60 back-20q.w]{3}\B\X3:Process the command line\X${}\E{}$\6
...
\N[76 back-20q.w]{1}{4}The strategy. All the critical data about partial
information is
...
\M[97 back-20q.w]{5}Initially all of the answers are unrestricted.
...
\M[102 back-20q.w]{6}Some of the questions are easy to deal with near the root
of the
...
\M[142 back-20q.w]{7}Here's a subroutine that illustrates the conventions. If
option \PB{\|x}
...
\M[164 back-20q.w]{8}The \PB{\\{innerforce}} routine throws out all options {%
\it but\/} \PB{\|x}.
...
\M[181 back-20q.w]{9}I'll need some help when debugging.
...
\M[201 back-20q.w]{10}\B\X7:Subroutines\X${}\mathrel+\E{}$\6
...
\M[211 back-20q.w]{11}\B\X7:Subroutines\X${}\mathrel+\E{}$\6
...
\N[226 back-20q.w]{1}{12}Backtracking. Here's the environment/context in which
...
\M[277 back-20q.w]{13}\B\X13:Restore saved state\X${}\E{}$\6
${}\{{}$\1\6
...
\M[283 back-20q.w]{14}\B\X14:Print a status report and reset \PB{\\{thresh}}%
\X${}\E{}$\6
${}\{{}$\1\6
...
\M[290 back-20q.w]{15}All changes to \PB{\\{mem}[\T{1}]} thru \PB{\\{mem}[%
\T{20}]} are made by the \PB{\\{remov}} and
...
\M[319 back-20q.w]{16}Finally all the deferred tests must be made.
...
\M[338 back-20q.w]{17}\B\X17:Print a solution\X${}\E{}$\6
$\\{count}\PP;{}$\6
...
\N[345 back-20q.w]{1}{18}The twenty questions. I'll quote each of the questions
here, verbatim,
...
\M[362 back-20q.w]{19}``1. The first question whose answer is A is: (A)~1 (B)~2
(C)~3 (D)~4 (E)~5''
...
\M[381 back-20q.w]{20}Deferred cases exit to \PB{\\{b5}} if the postponed test
fails.
...
\M[386 back-20q.w]{21}``2. The next question with the same answer as this one
is:
...
\M[404 back-20q.w]{22}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{1},\39\T{2},\39\|B){}$:\5
...
\M[418 back-20q.w]{23}``3. The only two consecutive questions with identical
...
\M[430 back-20q.w]{24}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{1},\39\T{3},\39\|A){}$:\5
...
\M[452 back-20q.w]{25}``4. The answer to this question is the same as the
...
\M[468 back-20q.w]{26}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{1},\39\T{4},\39\|A){}$:\5
...
\M[474 back-20q.w]{27}``5. The answer to question 14 is:
(A)~B (B)~E (C)~C (D)~A (E)~D''
...
\M[489 back-20q.w]{28}``6. The answer to this question is:
...
\M[498 back-20q.w]{29}``7. An answer that appears most often is:
(A)~A (B)~B (C)~C (D)~D (E)~E''
...
\M[507 back-20q.w]{30}\B\X30:Compute the distribution of answers\X${}\E{}$\6
${}\{{}$\1\6
...
\M[526 back-20q.w]{31}\B\X6:Other global variables\X${}\mathrel+\E{}$\6
\&{int} \\{dist}[\T{5}];\C{ the number of A's, B's, C's, D's, E's }\6
\&{int} \\{tie}[\T{5}];\C{ cases that are tied with at least one other }\6
\&{int} \\{trick};\par
\fi

\M[531 back-20q.w]{32}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{7},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{7},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{7},\39\|C){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{7},\39\|D){}$:\5
...
\M[539 back-20q.w]{33}``8. Ignoring answers that appear equally often, the
...
\M[548 back-20q.w]{34}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{8},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{8},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{8},\39\|C){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{8},\39\|D){}$:\5
...
\M[560 back-20q.w]{35}``9. The sum of all question numbers whose answers are
...
\M[571 back-20q.w]{36}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{9},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{9},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{9},\39\|C){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{9},\39\|D){}$:\5
...
\M[587 back-20q.w]{37}``10. The answer to question 17 is:
...
\M[602 back-20q.w]{38}``11. The number of questions whose answer is D is:
(A)~2 (B)~3 (C)~4 (D)~5 (E)~6''
...
\M[611 back-20q.w]{39}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{11},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{11},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{11},\39\|C){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{11},\39\|D){}$:\5
...
\M[619 back-20q.w]{40}``12. The number of {\it other\/} questions with the same
answer as this one
...
\M[642 back-20q.w]{41}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{12},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{12},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{12},\39\|C){}$:\5
...
\M[652 back-20q.w]{42}``13. The number of questions whose answer is E is:
(A)~5 (B)~4 (C)~3 (D)~2 (E)~1''
...
\M[661 back-20q.w]{43}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{13},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{13},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{13},\39\|C){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{13},\39\|D){}$:\5
...
\M[669 back-20q.w]{44}``14. No answer appears exactly this many times:
...
\M[684 back-20q.w]{45}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{14},\39\|A){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{14},\39\|B){}$:\5
\&{case} \\{pack}${}(\T{0},\39\T{14},\39\|C){}$:\5
...
\M[695 back-20q.w]{46}``15. The set of odd-numbered questions with answer A is:
...
\M[712 back-20q.w]{47}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
...
\M[724 back-20q.w]{48}``16. The answer to question 8 is the same as the answer
to question:
...
\M[739 back-20q.w]{49}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{0},\39\T{16},\39\|C){}$:\5
...
\M[745 back-20q.w]{50}``17. The answer to question 10 is:
...
\M[765 back-20q.w]{51}``18. The number of prime-numbered questions whose
...
\M[782 back-20q.w]{52}\B\X6:Other global variables\X${}\mathrel+\E{}$\6
...
\M[789 back-20q.w]{53}``19. The last question whose answer is B is:
...
\M[805 back-20q.w]{54}\B\X20:Cases for the deferred switch\X${}\mathrel+\E{}$\6
\4\&{case} \\{pack}${}(\T{1},\39\T{19},\39\|A){}$:\5
...
\M[812 back-20q.w]{55}``20. The maximum score that can be achieved on this test
is:
