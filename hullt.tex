...
\N[4 hullt.w]{1}{1}Introduction. This is a hastily written implementation of
the treehull
...
\M[32 hullt.w]{2}I'm instrumenting this in a simple way.
...
\N[42 hullt.w]{1}{3}Data structures.
...
\M[69 hullt.w]{4}\B\X4:Initialize the array of nodes\X${}\E{}$\6
...
\M[74 hullt.w]{5}\B\X2:Global variables\X${}\mathrel+\E{}$\6
...
\M[80 hullt.w]{6}We assume that the vertices have been given to us in a
GraphBase-type
...
\M[102 hullt.w]{7}We'll probably need a bunch of local variables to do
...
\M[110 hullt.w]{8}Here's a routine I used when debugging (in fact I should have
written
...
\M[126 hullt.w]{9}\B\X9:Procedures\X${}\E{}$\6
\&{int} \\{count};\7
\\{inorder}(\|p)\1\1\6
\&{node} ${}{*}\|p;\2\2{}$\6
${}\{{}$\1\6
...
\N[141 hullt.w]{1}{10}Hull updating.
...
\M[160 hullt.w]{11}Let me do the easy part first, since it's bedtime and I can
worry about
the rest tomorrow.
...
\M[171 hullt.w]{12}In Case 1 we don't need the tree structure since we've
already found
...
\M[197 hullt.w]{13}At this point \PB{$\|q\E\\{head}\MG\\{pred}$} is the tree's
rightmost node.
...
\M[207 hullt.w]{14}Nodes don't need to be recycled.
...
\M[237 hullt.w]{15}\B\X15:Do Case 2\X${}\E{}$\6
${}\{{}$\5
...
\M[281 hullt.w]{16}\B\X16:Insert \PB{\\{vv}} in tree, linked by \PB{\\{ppar}}%
\X${}\E{}$\6
${}\{{}$\1\6
${}\\{tt}\K\\{next\_node}\PP;{}$\6
${}\|o,\39\\{tt}\MG\\{vert}\K\\{vv};{}$\6
...
\N[289 hullt.w]{1}{17}Determinants. I need code for the primitive function \PB{%
\\{ccw}}.
