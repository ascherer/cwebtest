...
\N[2 queens.w]{1}{1}Data for dancing. This program creates data suitable for
the {\mc DANCE}
...
\M[21 queens.w]{2}\B\X2:Read the command line\X${}\E{}$\6
...
\M[29 queens.w]{3}\B\X3:Global variables\X${}\E{}$\6
\&{int} \\{param};\par
\U1.\fi

\M[32 queens.w]{4}We proces the cells of the board in ``organ pipe order,'' on
the assumption
...
\M[45 queens.w]{5}\B\X5:Subroutines\X${}\E{}$\6
\&{char} \\{encode}(\|x)\1\1\6
\&{int} \|x;\2\2\6
${}\{{}$\1\6
\&{if} ${}(\|x<\T{10}){}$\1\5
...
\M[53 queens.w]{6}\B\X6:Output the possible queen moves\X${}\E{}$\6
