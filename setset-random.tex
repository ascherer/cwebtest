...
\N{1}{1}Intro. This little program makes empirical tests by which I can
...
\M{3}\B\X3:Increase \PB{\\{count}} if there are no SETs\X${}\E{}$\6
...
\M{4}\B\X4:Shuffle the deck\X${}\E{}$\6
